...
<?php if ($this->configuration->getValue('list.batch_actions')): ?>
          <th id="sf_admin_list_batch_actions">
             <a href="#" id="sf_admin_list_batch_toggle" title="[?php echo __('Check/Uncheck all') ?]">
                 <img src="/sfRedminishAdminPlugin/images/toggle_check.png" alt="Toggle_check">
             </a>
          </th>
<?php endif; ?>
...
<?php endif; ?>
      ...
      <tbody>
        [?php foreach ($pager->getResults() as $i => $<?php echo $this->getSingularName() ?>): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?]
          <tr class="sf_admin_row [?php echo $odd ?] issue">
<?php if ($this->configuration->getValue('list.batch_actions')): ?>
