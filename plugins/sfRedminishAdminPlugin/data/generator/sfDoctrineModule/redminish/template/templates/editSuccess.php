...
<div id="main">
  ...
  [?php include_partial('<?php echo $this->getModuleName() ?>/breadcrumb', array('module_name' => '<?php echo $this->getModuleName() ?>','action_name' => $this->getActionName(), 'title' => <?php echo $this->getI18NString('edit.title') ?>)) ?]
